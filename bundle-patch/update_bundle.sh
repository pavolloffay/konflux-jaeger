...
# Separate due to merge conflicts
export JAEGER_ALL_IN_ONE_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/jaeger/jaeger-all-in-one@sha256:6c2b4c459683a87751e4b16b5b9d2e40b8f38d13da5e92b00df4b083e689e48d"
# Separate due to merge conflicts
