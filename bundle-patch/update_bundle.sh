...
export JAEGER_AGENT_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/jaeger/jaeger-agent@sha256:8bea0655450ab203360b8d03d386108f1dd289a4593af97afe445474353e1d42"
# Separate due to merge conflicts
